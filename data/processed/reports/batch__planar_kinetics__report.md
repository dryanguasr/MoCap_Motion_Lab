...
Protocolo para datos reales: `docs/PROTOCOLO_ADQUISICION_CINETICA.md`. Los artefactos pesados permanecen locales según `.gitignore`; los resúmenes e informes compactos pueden versionarse.
